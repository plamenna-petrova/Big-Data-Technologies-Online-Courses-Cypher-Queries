...
CREATE (reactEssentialsDeepDive:Material { title: "React Essentials - Deep Dive", type: "Video Lecture" }),
       ...
       (incomeStatemenetAnalysis:Material { title: "Income Statement Analysis", type: "Text-based" }),
       ...
       (introToEhereumProsAndConsTransactingInvestingAndMining:Material { title: "Intro to Ethereum (Pros & Cons, Transacting, Investing & Mining)", type: "Video Lecture" }),
...
CREATE (reactTheCompleteGuide)-[:INCLUDES_MATERIAL]->(reactEssentialsDeepDive),
       ...
       (introductionToFinanceAccountingModelingAndValuation)-[:INCLUDES_MATERIAL]->(incomeStatemenetAnalysis),
       ...
       (theCompleteCryptocurrencyCourse)-[:INCLUDES_MATERIAL]->(introToEhereumProsAndConsTransactingInvestingAndMining),
...
CREATE (johnDoe)-[:ENROLLED_FOR]->(reactTheCompleteGuide),
       (johnDoe)-[:ENROLLED_FOR]->(theModernAngularBootcamp),
       (johnDoe)-[:ENROLLED_FOR]->(kotlinForJavaDevelopers),
       (janeSmith)-[:ENROLLED_FOR]->(theModernAngularBootcamp),
       (janeSmith)-[:ENROLLED_FOR]->(aspNetCoreCrossPlatformDevelopment),
       (alexJohnson)-[:ENROLLED_FOR]->(anEntireMBAInOneCourse),
       (alexJohnson)-[:ENROLLED_FOR]->(theEssentialGuideToEntrepreneurship),
       (alexJohnson)-[:ENROLLED_FOR]->(introductionToFinanceAccountingModelingAndValuation),
       (emilyBrown)-[:ENROLLED_FOR]->(strategicInnovationAndExecution),
       (michaelDavis)-[:ENROLLED_FOR]->(theCompleteCryptocurrencyCourse),
       (sarahWilson)-[:ENROLLED_FOR]->(macroeconomicsAComprehensiveEconomicsCourse),
       (sarahWilson)-[:ENROLLED_FOR]->(microeconomicsAComprehensiveEconomicsCourse),
       (ryanTaylor)-[:ENROLLED_FOR]->(macroeconomicsAComprehensiveEconomicsCourse),
       (ryanTaylor)-[:ENROLLED_FOR]->(microeconomicsAComprehensiveEconomicsCourse),
       (oliviaMartinez)-[:ENROLLED_FOR]->(theCompleteEthicalHackingCourseBeginnerToAdvanced),
       (oliviaMartinez)-[:ENROLLED_FOR]->(theCompleteCyberSecurityCourseHackersExposed),
       (danielGarcia)-[:ENROLLED_FOR]->(completeWebAndMobileDesignerUXUIFigmaAndMore),
       (danielGarcia)-[:ENROLLED_FOR]->(wordPressForBeginnersCreateAWebsiteStepByStep),
       (samanthaAnderson)-[:ENROLLED_FOR]->(completeWebAndMobileDesignerUXUIFigmaAndMore),
       (samanthaAnderson)-[:ENROLLED_FOR]->(learnFigmaUXUIDesignEssentialTraining);
...
CREATE (maximilianSchwarzmüller)-[:UPLOADED_MATERIAL]->(reactEssentialsDeepDive),
       ...
       (chrisHaroun)-[:UPLOADED_MATERIAL]->(incomeStatemenetAnalysis),
       ...
       (chrisHaroun)-[:UPLOADED_MATERIAL]->(introToEhereumProsAndConsTransactingInvestingAndMining),
